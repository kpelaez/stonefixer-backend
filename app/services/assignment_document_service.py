...
class AssignmentDocumentGenerator:
    ...
    def _draw_main_title(self, c, y_position, width) -> float:
        ...
        title_lines = [
            "POLÍTICA DE USO Y RESPONSABILIDAD",
        ...
        c.setLineWidth(2)
        c.line(4*cm, y_position - 0.3*cm, width - 4*cm, y_position - 0.3*cm)
    ...
    def _draw_asset_section(self, c, y_position, left_margin, right_margin, asset_data, assignment_data) -> float:
        ...
        fields = [
            ...
            ("Asset Tag (nro. de serie):", asset_data.get("asset_tag", "N/A")),
            ("Accesorios:", assignment_data.get("accessories", "N/A")),
            ("Estado al momento de la asignación:", assignment_data.get("condition_at_assignment", "Buen estado"))
        ]
