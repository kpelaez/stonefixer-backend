...
from app.api.routes.inventario_routes import router as inventario_router
...
api_router.include_router(inventario_router, prefix="/api/v1/inventario", tags=["Inventario"])